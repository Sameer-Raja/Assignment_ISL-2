...
#a
college=read.csv("C:/Users/samee/downloads/College.csv", header=TRUE)
...
##chapter2 - problem 9
Auto = read.csv("C:/Users/samee/downloads/Auto.csv", header=TRUE)
Auto = na.omit(Auto)
dim(Auto)
...
##chapter3 - problem 9
Auto = read.csv("C:/Users/samee/downloads/Auto.csv", header=TRUE,na.strings = "?")
Auto = na.omit(Auto)
head(Auto)
Auto$origin[Auto$origin == 1] = "American"
Auto$origin[Auto$origin == 2] = "European"
